      ...
      <footer className="w-full max-w-5xl border-t border-zinc-800 mt-16 pt-8 pb-8">
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            <a
              href="https://buymeacoffee.com/markm678"
              target="_blank"
            ...
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M7.076 21.337H2.47a.641.641 0 0 1-.633-.74L4.944.901C5.026.382 5.474 0 5.998 0h7.46c2.57 0 4.578.543 5.69 1.81 1.01 1.15 1.304 2.42 1.012 4.287-.023.143-.047.288-.077.437-.983 5.05-4.349 6.797-8.647 6.797h-2.19c-.524 0-.968.382-1.05.9l-1.12 7.106zm14.146-14.42a3.35 3.35 0 0 0-.607-.541c-.013.076-.026.175-.041.254-.93 4.778-4.005 7.201-9.138 7.201h-2.19a.563.563 0 0 0-.556.479l-1.187 7.527h-.506l-.24 1.516a.56.56 0 0 0 .554.647h3.882c.46 0 .85-.334.922-.788.06-.26.76-4.852.997-6.346.038-.116.143-.2.26-.2h.562c3.794 0 6.762-1.54 7.632-5.994.315-1.615.136-2.959-.655-3.895z"/>
              </svg>
              PayPal
            </a>
            <a
